...
$plugin->version   = 2013051500; // The current module version (Date: YYYYMMDDXX)
...
$plugin->release = '1.0 (Build: 2013051500)';
$plugin->component = 'theme_unitec_tpalearningcentre'; // Full name of the plugin (used for diagnostics)
